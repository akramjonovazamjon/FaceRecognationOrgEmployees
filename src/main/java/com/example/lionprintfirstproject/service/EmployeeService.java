...
public class EmployeeService {
    ...
    public Employee create(CreateEmployee dto, MultipartFile file, Long departmentId, Long jobId) throws IOException {
        ...
        boolean b = cameraEmployeeService.saveEmployeeToCamera(savedEmployee, file, "http://192.168.0.191");
        employee.setAddedToEnter(b);
        b = cameraEmployeeService.saveEmployeeToCamera(savedEmployee, file, "http://192.168.0.192");
